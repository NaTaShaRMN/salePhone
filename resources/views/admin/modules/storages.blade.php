...
<div class="animated fadeIn" ng-app="appme" ng-controller="storageController">
  ...
  <div class="row" ng-init="csrf = '{{csrf_token()}}'">
    <div class="col-md-12">
      <div class="card">
        ...
        <div class="card-body">
          <table id="table-storages" ng-table='storages' class="table table-striped table-bordered">
          <colgroup>
            <col width="5%" />
            <col width="40%" />
            <col width="35%" />
            ...
            <col width="10%" />
              ...
              <tr ng-repeat="data in $data" ng-init="data.show=true;"> 
                ...
                <td title="'Kích cỡ'" style="text-align:center;"filter="{ size: 'number'}" sortable="'size'">
                    <div ng-show="data.show && (data.new || data.new == null)" >
                       {%data.size%}
                    </div>
                    <div  ng-hide="data.show && (data.new || data.new == null)" >
                        <input type="number" ng-model="data.size" class="form-control" >
                    </div>
                </td>

<div class="card col-lg-3 col-md-6 no-padding no-shadow">
	<div class="card-body bg-flat-color-3">
		...
		<div class="h4 mb-0 text-light">
			<span class="count">{{$pro}}</span>
		</div>
		<small class="text-light text-uppercase font-weight-bold">Sản phẩm</small>
...
<div class="card col-lg-3 col-md-6 no-padding no-shadow">
	<div class="card-body bg-flat-color-2" style="    background: #606f73;">
		...
		<div class="h4 mb-0 text-light">
			<span class="count">{{$or}}</span>
		</div>
		<small class="text-uppercase font-weight-bold text-light">Đơn hàng</small>
		<div class="progress progress-xs mt-3 mb-0 bg-light" style="width: 40%; height: 5px;"></div>
	</div>
</div>
<div class="card col-lg-3 col-md-6 no-padding no-shadow">
...
<div class="col-lg-6">
    <div class="card">
        <div class="card-body">
            <h4 class="mb-3">Đơn hàng 12 tháng </h4>
...
<div class="col-lg-6">
    <div class="card">
        <div class="card-body">
            <h4 class="mb-3">Sản phẩm theo nhãn hiệu </h4>

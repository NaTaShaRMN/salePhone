...
<div class="animated fadeIn" ng-app="appme" ng-controller="operatingSystemController">
  
  <div class="row" ng-init="csrf = '{{csrf_token()}}'">
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <strong class="card-title">Hệ điều hành</strong>
          <button class="btn btn-default" ng-click="new()" style="float: right;"><i class="fa fa-plus-square-o" style="font-style: 15px"></i></button>
        </div>
        <div class="card-body">
          <table id="table-op" ng-table='op' class="table table-striped table-bordered">
          <colgroup>
            <col width="5%" />
            <col width="40%" />
            <col width="35%" />

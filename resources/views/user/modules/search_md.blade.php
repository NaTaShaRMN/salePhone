                    ...
                    <div class="col-md-4 col-xs-6">
                        <div class="product">
                            <div class="product-img">
                                <img src="./storage/{{$products->link}}" alt="">
                            ...
                            <div class="product-body">
                                ...
                                <h3 class="product-name"><a href="{{URL::to('product',$products->id)}}">{{$products->name}}</a></h3>
                                <h4 class="product-price">{{$products->price}}đ<del class="product-old-price"></del></h4>
